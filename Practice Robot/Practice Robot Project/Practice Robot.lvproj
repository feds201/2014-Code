...
<Project Type="Project" LVVersion="13008000">
	<Property Name="varPersistentID:{085887C9-48FE-4718-832F-C08EE987BB7A}" Type="Ref">/RT CompactRIO Target/Globals.lvlib/Target Center</Property>
	<Property Name="varPersistentID:{0A606750-A056-47A1-A3AC-7D017AEDE8C7}" Type="Ref">/RT CompactRIO Target/Globals.lvlib/Hot or Not</Property>
	<Property Name="varPersistentID:{22429AE3-D3F0-4BFF-B0F0-C18CA207B471}" Type="Ref">/RT CompactRIO Target/Team Code/Teleop.vi/Edge Detect 2/error in</Property>
	<Property Name="varPersistentID:{2978DF40-F657-4EEF-A078-37E9BE2BFA76}" Type="Ref">/RT CompactRIO Target/Team Code/Teleop.vi/Edge Detect/input 2</Property>
	<Property Name="varPersistentID:{29E97959-E470-4F14-8711-522B0DF03645}" Type="Ref">/RT CompactRIO Target/Team Code/Teleop.vi/Edge Detect 1/error out</Property>
	<Property Name="varPersistentID:{33837D37-3589-4D8B-A7D7-7D8CEAB3D18E}" Type="Ref">/RT CompactRIO Target/Globals.lvlib/Reset Gyro</Property>
	<Property Name="varPersistentID:{37DC0781-8B77-4E6E-A800-8D9B2A72761F}" Type="Ref">/RT CompactRIO Target/Globals.lvlib/Scores</Property>
	<Property Name="varPersistentID:{392090DF-B863-4CCE-9066-27BC0450BCCD}" Type="Ref">/RT CompactRIO Target/Team Code/Teleop.vi/Edge Detect/error out</Property>
	<Property Name="varPersistentID:{3B514AE7-4659-4901-91D0-14EB118ECE11}" Type="Ref">/RT CompactRIO Target/Team Code/Teleop.vi/Edge Detect 2/input 2</Property>
	<Property Name="varPersistentID:{3E9D7674-AA2C-4F77-B61F-0675E4F4493D}" Type="Ref">/RT CompactRIO Target/Globals.lvlib/Encoder</Property>
	<Property Name="varPersistentID:{549499D1-7F6B-4742-9DA9-71816B7E35CF}" Type="Ref">/RT CompactRIO Target/Team Code/Teleop.vi/Edge Detect 1/output</Property>
	<Property Name="varPersistentID:{5643E6FD-DCC8-4715-9228-D0D878A8CF49}" Type="Ref">/RT CompactRIO Target/Team Code/Teleop.vi/Edge Detect/input 1</Property>
	<Property Name="varPersistentID:{5EE76C25-C047-4853-A18F-9336DDE20322}" Type="Ref">/RT CompactRIO Target/Team Code/Teleop.vi/Edge Detect 1/input 1</Property>
	<Property Name="varPersistentID:{6CA1C309-960A-41C7-B228-00C4264E3279}" Type="Ref">/RT CompactRIO Target/Team Code/Teleop.vi/Edge Detect 2/input 1</Property>
	<Property Name="varPersistentID:{6CF8612F-BCDB-4FA2-B24B-66C0F2848D2B}" Type="Ref">/RT CompactRIO Target/Team Code/Teleop.vi/Edge Detect 2/error out</Property>
	<Property Name="varPersistentID:{73E3E101-F6F7-4F80-B8CE-D016C4BB4EEE}" Type="Ref">/RT CompactRIO Target/Team Code/Teleop.vi/Edge Detect/error in</Property>
	<Property Name="varPersistentID:{7A9E44AD-C692-43E7-9DC1-133CD061A789}" Type="Ref">/RT CompactRIO Target/Globals.lvlib/Gyro</Property>
	<Property Name="varPersistentID:{808F9B4B-9870-46F1-888F-6E36924B782C}" Type="Ref">/RT CompactRIO Target/Team Code/Teleop.vi/Edge Detect 1/input 2</Property>
	<Property Name="varPersistentID:{BEEC5047-52C7-4551-B486-8C9432BD1E2E}" Type="Ref">/RT CompactRIO Target/Globals.lvlib/Gyro Angle</Property>
	<Property Name="varPersistentID:{C1961290-5693-4277-A605-B6F680EE97AE}" Type="Ref">/RT CompactRIO Target/Team Code/Teleop.vi/Edge Detect/output</Property>
	<Property Name="varPersistentID:{D7B4CB09-EE42-4D51-A17E-F58668F1CA45}" Type="Ref">/RT CompactRIO Target/Globals.lvlib/Distance (ft)</Property>
	<Property Name="varPersistentID:{DFCC4A0B-3517-4C2A-9957-FEB7C787F03B}" Type="Ref">/RT CompactRIO Target/Team Code/Teleop.vi/Edge Detect 2/output</Property>
	<Property Name="varPersistentID:{FA02034F-D7B8-40DC-A531-BB0E3217AC5A}" Type="Ref">/RT CompactRIO Target/Team Code/Teleop.vi/Edge Detect 1/error in</Property>
...
DirectoryIndex index.htm
		...
		<Item Name="Custom VI&apos;s" Type="Folder">
			<Item Name="Smart Dashboard Data.vi" Type="VI" URL="../Smart Dashboard Data.vi"/>
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="TargetType.ctl" Type="VI" URL="../../2014 Dashboard Project/Vision Processing/TargetType.ctl"/>
		...
		<Item Name="Build Specifications" Type="Build">
			<Item Name="FRC Robot Boot-up Deployment" Type="{69A947D5-514E-4E75-818E-69657C0547D8}">
				...
				<Property Name="Source[0].itemID" Type="Str">{99138C84-3BE2-4DE0-90FD-F8636C6B368C}</Property>
